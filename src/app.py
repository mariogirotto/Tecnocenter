...
class Producto(db.Model):   # la clase Producto hereda de db.Model     
    ...
    def __init__(self,nombre,precio,stock, foto, categoria):   #crea el  constructor de la clase
...
class ProductoSchema(ma.Schema):
    class Meta:
        fields=('id','nombre','precio','stock', 'foto', 'categoria')
...
def create_producto():
    ...
    new_producto=Producto(nombre,precio,stock,foto,categoria)
